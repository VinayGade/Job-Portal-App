...
import com.app.jobportal.service.*;
    ...
    public String display(@PathVariable("id") int id, Model model){
        ...
        if(!(authentication instanceof AnonymousAuthenticationToken)){
            if(authentication.getAuthorities().contains(new SimpleGrantedAuthority("Recruiter"))){
                ...
                JobSeekerProfile candidateProfile = jobSeekerProfileService.getCurrentSeekerProfile();
                if(candidateProfile != null){
                    ...
                    for(JobSeekerApply jobSeekerApply: jobSeekerApplyList){
                        if(jobSeekerApply.getUserId().getUserAccountId() ==
                                candidateProfile.getUserAccountId()){
                            exists = true;
                            break;
                        }
                    }
    ...
    public String apply(@PathVariable("id") int id, JobSeekerApply jobSeekerApply){
        ...
        if(!(authentication instanceof AnonymousAuthenticationToken)){
            ...
            if(candidateProfile.isPresent() && jobPostActivity != null){
                ...
                //}
                jobSeekerApply.setUserId(candidateProfile.get());
