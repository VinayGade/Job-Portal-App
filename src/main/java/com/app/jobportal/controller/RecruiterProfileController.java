...
import com.app.jobportal.service.RecruiterProfileService;
...
public class RecruiterProfileController {
    ...
    public String recruiterProfile(Model model){
        ...
        if(!(authentication instanceof AnonymousAuthenticationToken)){
            ...
            Optional<RecruiterProfile> recruiterProfile = recruiterProfileService.getOne(
                    users.getUserId());
            ...
            // functional - style replacement for above code...
