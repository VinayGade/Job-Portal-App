...
import com.app.jobportal.service.JobPostActivityService;
import com.app.jobportal.service.JobSeekerProfileService;
import com.app.jobportal.service.JobSeekerSaveService;
import com.app.jobportal.service.UsersService;
...
public class JobSeekerSaveController {
    ...
    public String save(@PathVariable("id") int id, JobSeekerSave jobSeekerSave){
        ...
        if(!(authentication instanceof AnonymousAuthenticationToken)){
            ...
            Optional<JobSeekerProfile> candidateProfile =
            ...
            if(candidateProfile.isPresent() && jobPostActivity != null){
                ...
                jobSeekerSave.setUserId(candidateProfile.get());
            }else{
